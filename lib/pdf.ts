...
function InvoicePDF({ invoice, settings }: { invoice: Invoice; settings: Settings }) {
  return React.createElement(Document, null,
    React.createElement(Page, { size: 'A4', style: styles.page },
      ...
      settings.terms_and_conditions && React.createElement(View, { style: styles.termsSection },
        React.createElement(Text, { style: styles.termsTitle }, 'Terms and Conditions'),
        React.createElement(Text, { style: styles.termsText }, settings.terms_and_conditions),
      ),
      // Signature line
      React.createElement(View, { style: styles.signatureSection },
        ...
        React.createElement(View, { style: styles.signatureDateBlock },
          React.createElement(View, { style: styles.signatureLine }),
...
export async function generateInvoicePDF(invoice: Invoice, settings: Settings): Promise<ArrayBuffer> {
  const element = InvoicePDF({ invoice, settings })
